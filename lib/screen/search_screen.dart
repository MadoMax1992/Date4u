            ...
            children: [
              ...
              Padding(
                ...
                child: Center(
                  child: Row(
                    children: [
                      Text(
                        'Min HornLength: ${_hornLengthRange.start.round()}',
                        style: TextStyle(
                            fontSize: fontSize, fontWeight: FontWeight.bold),
                      ),
                      SizedBox(
                      ...
                      Text(
                        'Max HornLength: ${_hornLengthRange.end.round()}',
                        style: TextStyle(
                            fontSize: fontSize, fontWeight: FontWeight.bold),
                      )
                    ],
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        ], value: _genderValue, onChanged: dropDownCallback)
                      ],
                    ),
              ...
              Padding(
                ...
                child: FutureBuilder<List<Profile>>(
                    future: httpHelper.getProfiles(
                        _ageRange.start.toInt(),
                        _ageRange.end.toInt(),
                        _hornLengthRange.start.toInt(),
                        _hornLengthRange.end.toInt(),
                        int.parse(_genderValue)),
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                                'Age: ${profileHelper.calculateAge(DateTime.parse(profile.birthdate))}'),
                                          ],
                                        ),
                                      ),
                                      Padding(
