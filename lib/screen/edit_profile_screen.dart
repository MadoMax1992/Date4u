...
class _EditProfileState extends State<EditProfile> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            profileRow('Hornlength', txtHornLength, loggedInProfile.hornLength.toString(), 1),
            profileRow('Gender', txtGender, loggedInProfile.gender.toString(), 1),
            profileRow('AttractedTo', txtAttractedToGender, loggedInProfile.attractedToGender.toString(), 1),
            profileRow('Description', txtDescription, loggedInProfile.description, 5),
  ...
  void save() {
    Profile updatedProfile = Profile(loggedInProfile.id, txtNickname.text, txtBirthdate.text,
      int.parse(txtHornLength.text), int.parse(txtGender.text), int.parse(txtAttractedToGender.text), txtDescription.text, loggedInProfile.lastSeen, loggedInProfile.photos);
  ...
  Widget profileRow(String label, TextEditingController editingController, String profileData, int lines) {
